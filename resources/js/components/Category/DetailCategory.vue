<template>
    <div>
     <div class="card-header mb-3"><h3> détails de Catégorie </h3></div>
        <div class="row m-2">
            <div class="col-md-8">
            <h3> <span class="badge badge-secondary bdgtitle">{{count_agents}} Articles dans Catégorie {{ name }} </span></h3>
            </div>
