            ...
            <table class="form-table">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="p-2 text-center">Quantité</th>
                    </tr>
                </thead>
                <tbody>
   ...
   import Vue from 'vue'
    ...
    import {Typeahead } from '../../components/typeahead'
     ...
     function initialize(to) {
        let urls = {
            'create': `/api/retourn/create`,
            'edit': `/api/retourn/${to.params.id}/edit`
        }
        ...
        methods: {
            setData(res) {
                ...
                if(this.$route.meta.mode === 'edit') {
                    this.store = `/api/retourn/${this.$route.params.id}`
                    this.method = 'PUT'
                    this.title = 'Modifier'
                }
            ...
            onSave() {
                ...
                let forms= this.form.articles;
                         forms.forEach(element => {
                              var newqnt= parseInt(element.article.qnt) + parseInt(element.qnt);
                              console.log(newqnt);
                              const config = {
