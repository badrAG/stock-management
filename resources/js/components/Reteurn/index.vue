<template>
    <div class="panel">
        <div class="panel-heading">
            <span class="panel-title">Retourns</span>
            <div>
                <router-link to="/retourn/create" class="btn btn-primary">
            ...
            <table class="table table-link">
                ...
                <tbody>
                    ...
                    <tr v-for="item in model.data" :key="item.data" @click="detailsPage(item)">
                        ...
                        <router-link  :to="{path : '/retourn/'+item.id}">
                        <td class="w-3">
...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            ...
            detailsPage(item) {
                this.$router.push(`/retourn/${item.id}`)
            },
            setData(res) {
